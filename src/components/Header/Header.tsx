    ...
    <header className="header">
      <div className="top-header">
        <div className="item-top-header">
          ...
          <p>
            Compra <span className="text-other">100% segura</span>
          </p>
        </div>
        ...
        <div className="item-top-header">
          ...
          <p>
            <span className="text-other">Frete grátis</span> acima de R$ 200
          </p>
        </div>
        ...
        <div className="item-top-header">
          ...
          <p>
            <span className="text-other">Parcele</span> suas compras
          </p>
        </div>
      </div>
      ...
      <nav className="nav-menu">
        ...
        <a href="#">
          <img src={CrowIcon} alt="Assinatura" /> Assinatura
        </a>
      </nav>
    </header>
  );
